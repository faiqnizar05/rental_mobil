        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-5" style="padding: 0px">
                    <figure><img style=" height: 300px; width: 400px"  src="{{ asset('storage/image/'.$car->photo) }}" alt="#" /></figure>
                    <div class="detail" style="margin-left: 40px; background-color: white; width: 400px; height: max-content; padding: 1rem">
                        ...
                        <p>No Plate : {{($car->license_plate)}}</p>
                        <p >Price : Rp. {{number_format($car->cost_per_day)}} / hari</p>
                    </div>
                </div>
                <div class="col-sm-7">
                    <div class="row">
                        <div class="col-12">
                            <form class="main_form" action="/submit-sewa" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="titlepage">
                                    <h2>Form Total Sewa</h2>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            <label for="">Tanggal Mulai</label>
                                            <input type="date" class="form-control" readonly value="{{$data['tanggal_mulai']}}" name="tanggal_mulai">
                                        </div>
                                    </div>
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            <label for="">Tanggal Selesai</label>
                                            <input type="date" class="form-control" readonly value="{{$data['tanggal_selesai']}}" name="tanggal_selesai">
                                        </div>
                                    </div>
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            <label for="">Waktu Sewa (hari)</label>
                                            <input type="text" class="form-control" readonly value="{{$data['lamanyaMinjam']}}" >
                                        </div>
                                    </div>
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            <label for="">Total</label>
                                            <input type="text" class="form-control" readonly value="{{$data['total']}}" name="total">
                                            <input type="hidden" class="form-control" readonly value="{{$car->id}}" name="car_id">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <button type="submit" class="find_btn">Sewa</button>
                                    </div>
                                </div>
                            </form>
                        </div>
